...
| file | use it for |
|---|---|
| `2026-09-15-pb158-lecture-2-io-from-python-to-the-os-handout.pdf` | **Start here.** The argument written out in full, with the complete source list and a summary of every source that is not publicly reachable. This is the densest and most reliable document in the folder. |
