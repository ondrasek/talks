...
This course grades you on whether you can look at what a system actually does, not on whether you can recite what it should do — and you can already recite more than you can predict.

## What is in this archive

| file | what it is |
|---|---|
| `2026-09-15-pb158-lecture-1-course-orientation-and-io-slides.pdf` | the deck, one page per slide |
| `2026-09-15-pb158-lecture-1-course-orientation-and-io-handout.pdf` | the written version, with every source and a one-page summary of each one |
| `2026-09-15-pb158-lecture-1-course-orientation-and-io-speaker-notes.pdf` | the notes the talk was given from |
