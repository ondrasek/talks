...
| file | use it for |
|---|---|
| `2026-09-22-pb158-lecture-3-finishing-io-and-advanced-io-handout.pdf` | **Start here.** The argument written out in full, with the complete source list and a summary of every source that is not publicly reachable. This is the densest and most reliable document in the folder. |
| `2026-09-22-pb158-lecture-3-finishing-io-and-advanced-io-slides.pdf` | What the audience saw, one page per slide. Use it to locate *where* in the talk something was said. |
| `2026-09-22-pb158-lecture-3-finishing-io-and-advanced-io-speaker-notes.pdf` | What was said around each slide. Use it when the slide is terse and the reasoning is not on it. |
...
- **`[S1]`, `[S2]`, …** — an external source. The handout's source list gives
  the title and a URL. You cannot fetch it unless the user has given you network
  access, and you should not pretend to have read it. Cite it by number and say
  what the handout says about it.
- **`[V1]`, `[V2]`, …** — a note from the speaker's private working vault. The
  note itself is **not in this folder and never will be**. What *is* here is a
  summary of it in the handout's appendix, which carries the note's own external
  references. When a user asks about a `[V]` source, answer from that summary and
  say plainly that it is a summary of a private note rather than the note.
...
- Point to where you got it: slide number, handout section, or source marker.
  The user should be able to check you.
...
document written to stand alone. Carry the source markers into whatever you
...
PB158 · Lecture 3 — Finishing I/O, and advanced I/O — Ondřej (Ondra) Krajíček in Czech contexts, Ondrej (Ondra) Krajicek in international ones — me@ondrejkrajicek.com · https://linkedin.com/in/OndrejKrajicek
