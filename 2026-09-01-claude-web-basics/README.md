...
A handful of prompting habits plus three pre-built company Claude Web projects (Prompt Engineering, Personalization, LinkedIn posts) are enough for non-technical IDEA StatiCa staff to get real work done with Claude today — and learning to build and share your own project is what makes that repeatable.

## What is in this archive

| file | what it is |
|---|---|
| `2026-09-01-claude-web-basics-slides.pdf` | the deck, one page per slide |
| `2026-09-01-claude-web-basics-handout.pdf` | the written version, with every source and a one-page summary of each one |
| `2026-09-01-claude-web-basics-speaker-notes.pdf` | the notes the talk was given from |
